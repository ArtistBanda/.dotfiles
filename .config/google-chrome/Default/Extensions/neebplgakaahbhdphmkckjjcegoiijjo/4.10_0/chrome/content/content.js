...
var onlyStock = !1, scanner = function() {
  function c(c, g, q, n, H, B) {
    var l = new XMLHttpRequest, t = !1, f = setTimeout(function() {
      t = !0;
      B();
    }, n || 4000);
    l.onreadystatechange = function() {
      t || (clearTimeout(f), H(l));
    };
    l.onerror = B;
    l.open(g, c, !0);
  ...
  function n(l, g) {
    ...
    if (null == document.body) {
      ...
      if (document.body.textContent.match("you're not a robot")) {
        ...
        for (var n = document.evaluate("//comment()", document, null, XPathResult.ANY_TYPE, null), t = n.iterateNext(), B = ""; t;) {
          B += t, t = n.iterateNext();
        }
        if (B.match(/automated access|api-services-support@/)) {
          ...
          if (B.match(/ref=cs_503_link/)) {
            ...
            if (l.scrapeFilters && 0 < l.scrapeFilters.length) {
              n = {};
              t = null;
              var y = "", f = null, u = {}, x = {}, I = !1, w = function(a, b, e) {
                var h = [];
                if (!a.selector) {
                  if (!a.regExp) {
              ...
              for (r in l.scrapeFilters) {
                b.$jscomp$loop$prop$pageType$71 = r;
                a: {
                  if (a) {
                    break;
                  }
                  b.$jscomp$loop$prop$pageFilter$68 = l.scrapeFilters[b.$jscomp$loop$prop$pageType$71];
                  var k = b.$jscomp$loop$prop$pageFilter$68.pageVersionTest, h = document.querySelectorAll(k.selector);
                  ...
                  if (0 != h.length) {
                    ...
                    t = b.$jscomp$loop$prop$pageType$71;
                    h = {};
                    for (var d in b.$jscomp$loop$prop$pageFilter$68) {
                      if (a) {
                        break;
                      }
                      h.$jscomp$loop$prop$sel$64 = b.$jscomp$loop$prop$pageFilter$68[d];
                      if (h.$jscomp$loop$prop$sel$64.name != k.name) {
                        if (h.$jscomp$loop$prop$sel$64.parentList) {
                          e = [];
                          if ("undefined" != typeof u[h.$jscomp$loop$prop$sel$64.parentList]) {
                            e = u[h.$jscomp$loop$prop$sel$64.parentList];
                          } else {
                            if (!0 === w(b.$jscomp$loop$prop$pageFilter$68[h.$jscomp$loop$prop$sel$64.parentList], B, b.$jscomp$loop$prop$pageType$71)) {
                              e = u[h.$jscomp$loop$prop$sel$64.parentList];
                            } else {
                              break;
                            }
                          }
                          x[h.$jscomp$loop$prop$sel$64.parentList] || (x[h.$jscomp$loop$prop$sel$64.parentList] = []);
                          var C = 0, v = {}, z;
                          for (z in e) {
                            if (a) {
                              break;
                            ...
                            if (e.hasOwnProperty(z)) {
                              if ("lager" == h.$jscomp$loop$prop$sel$64.name) {
                                C++;
                                try {
                                  var m = void 0, p = void 0;
                                  h.$jscomp$loop$prop$sel$64.selector && (m = e[z].querySelector(h.$jscomp$loop$prop$sel$64.selector));
                                  h.$jscomp$loop$prop$sel$64.altSelector && (p = e[z].querySelector(h.$jscomp$loop$prop$sel$64.altSelector));
                                  p && (p = p.getAttribute(h.$jscomp$loop$prop$sel$64.attribute));
                                  var D = 999, L = !1;
                                  try {
                                  ...
                                  if (!p) {
                                    try {
                                      var E = JSON.parse(h.$jscomp$loop$prop$sel$64.regExp);
                                      if (E.sel1) {
                                        try {
                                  ...
                                  if (m) {
                                    A++;
                                    v.$jscomp$loop$prop$mapIndex$65 = z + "";
                                    v.$jscomp$loop$prop$busy$66 = !0;
                                    ...
                                    null == F || 9 > F.length || (chrome.runtime.sendMessage({type:"getStock", asin:F, oid:p, maxQty:D, isMAP:L, host:document.location.hostname, referer:document.location + "", domainId:l.domainId, force:!0, session:"unknown"}, function(a, b) {
                                      return function(d) {
                                        a.$jscomp$loop$prop$busy$66 && (a.$jscomp$loop$prop$busy$66 = !1, "undefined" != typeof d && (d.error ? console.log(d.error) : (x[b.$jscomp$loop$prop$sel$64.parentList][a.$jscomp$loop$prop$mapIndex$65][b.$jscomp$loop$prop$sel$64.name] = d, 0 == --A && g(q))));
                                      };
                                    }(v, h)), setTimeout(function(a) {
                                      return function() {
                                        a.$jscomp$loop$prop$busy$66 && 0 == --A && (a.$jscomp$loop$prop$busy$66 = !1, g(q));
                                      };
                                    }(v), 2000));
                                  }
                                } catch (J) {
                                ...
                                if ("revealMAP" == h.$jscomp$loop$prop$sel$64.name) {
                                  v.$jscomp$loop$prop$revealMAP$69 = h.$jscomp$loop$prop$sel$64, m = void 0, m = v.$jscomp$loop$prop$revealMAP$69.selector ? e[z].querySelector(v.$jscomp$loop$prop$revealMAP$69.selector) : e[z], null != m && m.textContent.match(new RegExp(v.$jscomp$loop$prop$revealMAP$69.regExp, "i")) && (m = document.location.href.match(/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/), m = m[1], p = b.$jscomp$loop$prop$pageFilter$68.sellerId, "undefined" == typeof p || null == p || null == m || 
                                  2 > m.length || (p = e[z].querySelector('input[name="oid"]').value, null == p || 20 > p + 0 || (m = v.$jscomp$loop$prop$revealMAP$69.altSelector.replace("OFFERID", p).replace("ASINID", m), A++, v.$jscomp$loop$prop$mapIndex$14$70 = z + "", c(m, "GET", null, 3000, function(a, b) {
                                    return function(d) {
                                      if (4 == d.readyState) {
                                        A--;
                                        if (200 == d.status) {
                                          try {
                                            var e = d.responseText, h = a.$jscomp$loop$prop$pageFilter$68.price;
                                            if (h && h.regExp) {
                                              if (e.match(/no valid offer--/)) {
                                                x[b.$jscomp$loop$prop$revealMAP$69.parentList][b.$jscomp$loop$prop$mapIndex$14$70] || (x[b.$jscomp$loop$prop$revealMAP$69.parentList][b.$jscomp$loop$prop$mapIndex$14$70] = {}), x[b.$jscomp$loop$prop$revealMAP$69.parentList][b.$jscomp$loop$prop$mapIndex$14$70][b.$jscomp$loop$prop$revealMAP$69.name] = -1;
                                              } else {
                                                var r = e.match(new RegExp("price info--\x3e(?:.|\\n)*?" + h.regExp + "(?:.|\\n)*?\x3c!--")), k = e.match(/price info--\x3e(?:.|\n)*?(?:<span.*?size-small.*?">)([^]*?<\/span)(?:.|\n)*?\x3c!--/);
                                                if (!r || r.length < h.reGroup) {
                                                  f += " //  priceMAP regexp fail: " + (e + " - " + h.name + a.$jscomp$loop$prop$pageType$71);
                                                } else {
                                                  var c = r[h.reGroup];
                                                  x[b.$jscomp$loop$prop$revealMAP$69.parentList][b.$jscomp$loop$prop$mapIndex$14$70] || (x[b.$jscomp$loop$prop$revealMAP$69.parentList][b.$jscomp$loop$prop$mapIndex$14$70] = {});
                                                  x[b.$jscomp$loop$prop$revealMAP$69.parentList][b.$jscomp$loop$prop$mapIndex$14$70][b.$jscomp$loop$prop$revealMAP$69.name] = c;
                                                  null != k && 2 == k.length && (x[b.$jscomp$loop$prop$revealMAP$69.parentList][b.$jscomp$loop$prop$mapIndex$14$70][b.$jscomp$loop$prop$revealMAP$69.name + "Shipping"] = k[1].replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " "));
                                                }
                                              }
                                            }
                                          } catch (U) {
                                  ...
                                  m = w(h.$jscomp$loop$prop$sel$64, e[z], b.$jscomp$loop$prop$pageType$71);
                                  if (!1 === m) {
                                    a = !0;
                                    break;
                                  }
                                  if (!0 !== m) {
                                    if (x[h.$jscomp$loop$prop$sel$64.parentList][z] || (x[h.$jscomp$loop$prop$sel$64.parentList][z] = {}), h.$jscomp$loop$prop$sel$64.multiple) {
                                      for (var K in m) {
                                        m.hasOwnProperty(K) && !h.$jscomp$loop$prop$sel$64.keepBR && (m[K] = m[K].replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " "));
                                      }
                                      m = m.join("\u271c\u271c");
                                      x[h.$jscomp$loop$prop$sel$64.parentList][z][h.$jscomp$loop$prop$sel$64.name] = m;
                                    } else {
                                      x[h.$jscomp$loop$prop$sel$64.parentList][z][h.$jscomp$loop$prop$sel$64.name] = h.$jscomp$loop$prop$sel$64.keepBR ? m : m.replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " ");
                                    }
                                  }
                                }
                              }
                            }
                            v = {$jscomp$loop$prop$busy$66:v.$jscomp$loop$prop$busy$66, $jscomp$loop$prop$mapIndex$65:v.$jscomp$loop$prop$mapIndex$65, $jscomp$loop$prop$revealMAP$69:v.$jscomp$loop$prop$revealMAP$69, $jscomp$loop$prop$mapIndex$14$70:v.$jscomp$loop$prop$mapIndex$14$70};
                          }
                        } else {
                          e = w(h.$jscomp$loop$prop$sel$64, B, b.$jscomp$loop$prop$pageType$71);
                          if (!1 === e) {
                            a = !0;
                            break;
                          }
                          if (!0 !== e) {
                            if (h.$jscomp$loop$prop$sel$64.multiple) {
                              for (var M in e) {
                                e.hasOwnProperty(M) && !h.$jscomp$loop$prop$sel$64.keepBR && (e[M] = e[M].replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " "));
                              }
                              e = e.join();
                            } else {
                              h.$jscomp$loop$prop$sel$64.keepBR || (e = e.replace(/(\r\n|\n|\r)/gm, " ").replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, " "));
                            }
                            n[h.$jscomp$loop$prop$sel$64.name] = e;
                          }
                        }
                      }
                      h = {$jscomp$loop$prop$sel$64:h.$jscomp$loop$prop$sel$64};
                    }
                    a = !0;
                  }
                }
                b = {$jscomp$loop$prop$pageFilter$68:b.$jscomp$loop$prop$pageFilter$68, $jscomp$loop$prop$pageType$71:b.$jscomp$loop$prop$pageType$71};
              }
              if (null == t) {
...
(function() {
  var c = !1, n = !1, g = window.opera || -1 < navigator.userAgent.indexOf(" OPR/"), l = -1 < navigator.userAgent.toLowerCase().indexOf("firefox"), t = -1 < navigator.userAgent.toLowerCase().indexOf("edge/"), q = /Apple Computer/.test(navigator.vendor) && /Safari/.test(navigator.userAgent), G = !g && !l && !t & !q, H = l ? "Firefox" : q ? "Safari" : G ? "Chrome" : g ? "Opera" : t ? "Edge" : "Unknown", B = chrome.runtime.getManifest().version, A = !1;
  try {
  ...
  if (!window.keepaHasRun) {
    ...
    var f = {domain:0, iframeStorage:null, ASIN:null, tld:"", placeholder:"", cssFlex:function() {
              ...
              if ((e || "com" == f.tld) && !f.revealWorking) {
                if (f.revealWorking = !0, document.getElementById("keepaMAP")) {
                  ...
                  var d = function() {
                    ...
                    if ("undefined" == typeof f.revealCache[e]) {
                      ...
                      if (d || r) {
                        ...
                        "undefined" != typeof f.revealCache[e] && -1 != f.revealCache[e] ? v(f.revealCache[e]) : chrome.runtime.sendMessage({type:"getStock", asin:b, oid:e, sellerId:g, maxQty:m, isMAP:d, host:document.location.hostname, force:d, referer:document.location + "", domainId:f.domain, cachedStock:f.revealCache[g], session:h}, function(a) {
                          if ("undefined" != typeof a && null != a) {
                            if (a.error) {
                              ...
                              f.revealCache[e] = a, f.revealCache[g] = a, v(a);
                            }
                          }
                        });
                      }
                                ...
                                if (e) {
                                  ...
                                  if (b) {
                                    for (m = 0; m < b.soldByOffers.length; m++) {
                                      var D = p.querySelector(b.soldByOffers[m]);
                                      if (null != D) {
                                        var t = D.getAttribute("href");
                                        null == t && (t = D.innerHTML);
                                        c = k(t);
                                        if (null != c) {
                                          break;
                                        }
                  ...
                  if (null != p && null != p.value) {
                    var q = p.parentElement.querySelector("#session-id"), t = p.parentElement.querySelector("#ASIN");
                    if (null != q && null != t) {
                      for (n = 0; n < b.mainEl.length; n++) {
                        var w = document.querySelector(b.mainEl[n]);
                        if (null != w) {
                          h(w, t.value, !1, p.value, q.value, !1, !1, a);
                          break;
                        }
                      }
                    }
      ...
      if (!(6E5 > k - f.lastBugReport || /(dead object)|(Script error)|(\.location is null)/i.test(a))) {
        ...
        null != c.url && c.url.startsWith("blob:") || (c.keepaType = G ? "keepaChrome" : g ? "keepaOpera" : q ? "keepaSafari" : t ? "keepaEdge" : "keepaFirefox", c.version = B, chrome.storage.local.get("token", function(a) {
    ...
    if (window.self == window.top && (document.addEventListener("DOMContentLoaded", function(a) {
      ...
      var u = document.location.href, x = !1;
      document.addEventListener("DOMContentLoaded", function(a) {
        if (!x) {
          try {
            if (u.startsWith("https://test.keepa.com") || u.startsWith("https://keepa.com")) {
      ...
      var I = !1;
      u.match(/^htt(p|ps):\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|es|nl|in|com\.mx|com\.br|com\.au)\/s\?/) ? (onlyStock = !0, f.onPageLoad()) : /((\/images)|(\/review)|(\/customer-reviews)|(ask\/questions)|(\/product-reviews))/.test(u) || /\/e\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/.test(u) || !(u.match(/^htt(p|ps):\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|es|nl|in|com\.mx|com\.br|com\.au)\/[^.]*?(\/|[?&]ASIN=)([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/) || u.match(/^htt(p|ps):\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|es|nl|in|com\.mx|com\.br|com\.au)\/(.*?)\/dp\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))\//) || 
      u.match(/^htt(p|ps):\/\/.*?\.amzn\.(com).*?\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/)) ? u.match(/^htt(p|ps):\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|nl|es|in|com\.mx|com\.br|com\.au)\/[^.]*?\/(wishlist|registry)/) || u.match(/^htt(p|ps):\/\/w*?\.amzn\.(com)[^.]*?\/(wishlist|registry)/) || (u.match("^https?://.*?(?:seller).*?.amazon.(de|com|co.uk|co.jp|ca|fr|it|nl|es|in|com.mx|com.br|com.au)/") ? l("s" + f.getDomain(RegExp.$1)) : u.match(/^https?:\/\/.*?(?:af.?ilia|part|assoc).*?\.amazon\.(de|com|co\.uk|co\.jp|nl|ca|fr|it|es|in|com\.mx|com\.br|com\.au)\/home/) && 
      ...
      if (!A) {
        ...
        (I || u.match(l)) && document.addEventListener("DOMContentLoaded", function(a) {
          var b = null;
          chrome.runtime.sendMessage({type:"getFilters"}, function(a) {
            b = a;
            if (null != b && null != b.value) {
              var c = function() {
                var b = u.match("^https?://.*?.amazon.(de|com|co.uk|co.jp|ca|fr|it|es|in|com.br|nl|com.mx)/");
                if (I || b) {
                ...
                if (1 == b) {
                  ...
                  if (void 0 != d && null != d) {
                    for (e = 0; e < d.length; e++) {
                      var l = d[e].href;
                      /\/images/.test(l) || /\/e\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/.test(l) || !l.match(/^https?:\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|es|in|com\.mx)\/[^.]*?(?:\/|\?ASIN=)([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/) && !l.match(/^https?:\/\/.*?\.amzn\.(com)[^.]*?\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/) || (g || -1 == l.indexOf("offer-listing")) && w.add_events(c, f, d[e], l, RegExp.$1, RegExp.$2);
                    }
                  }
                  var n = function(a) {
                    if ("A" == a.nodeName) {
                      var b = a.href;
                      /\/images/.test(b) || /\/e\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/.test(b) || !b.match(/^https?:\/\/.*?\.amazon\.(de|com|co\.uk|co\.jp|ca|fr|it|es|in|com\.mx)\/[^.]*?(?:\/|\?ASIN=)([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/) && !b.match(/^https?:\/\/.*?\.amzn\.(com)[^.]*?\/([BC][A-Z0-9]{9}|\d{9}(!?X|\d))/) || (g || -1 == b.indexOf("offer-listing")) && w.add_events(c, f, a, b, RegExp.$1, RegExp.$2);
                    }
        ...
        var w = {image_urls_main:[], pf_preview_current:"", preview_images:[], tld:"", img_string:'<img style="border: 1px solid #ff9f29;  -moz-border-radius: 0px;  margin: -3px;   display:block;   position: relative;   top: -3px;   left: -3px;" src=\'', createNewImageElement:function(a) {
          ...
          if (!w.pf_preview_current.firstChild) {
            ...
            w.pf_preview_current.a = h;
            w.pf_preview_current.href = f;
            w.pf_preview_current.size = Math.floor(1.1 * Math.min(k, g));
            ...
            var m = w.createNewImageElement(d);
          ...
          0 <= f.indexOf("#") || (w.tld = g, "pf_prevImg" != c.getAttribute("keepaPreview") && (c.addEventListener("mouseover", function(c) {
            w.preview_image(a, b, c, f, e, g);
            return !0;
